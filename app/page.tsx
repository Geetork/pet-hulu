        ...
        <section className="flex flex-col bg-gradient-to-b from-emerald-600 via-emerald-950 to-black h-fit justify-center items-center pb-4">
          ...
          <div className="flex items-center max-w-[336px] h-[44px]">
            <Button
              ...
              type='secondary'
              className="bg-transparent text-gray-300 border-[1px] hover:border-gray-300/50 hover:bg-gray-300/60 hover:text-black"
            />
          </div>
        </section>

        <section className="flex flex-col items-center gap-2 w-full py-8 bg-black">
          <h1 className="text-green-primary text-xs font-bold">
