                    ...
                    <div key={id} className='flex-1'>
                        {
                            subscription[field] ? 
                                subscription[field] === true ? 
                                    <div className='relative w-full h-0 pb-[8%] md:pb-[4%]'>
                                        <Image 
                                            src={`${basePath}/assets/icon-green-ok.svg`} 
                                            alt='ok' 
                                            layout='fill'
                                            objectFit='contain'/>
                                    </div> : 
    ...
    return (
        <section className='flex flex-col w-full'>
            <div className='sticky top-0 flex w-full justify-between 
                            md:w-full md:justify-end my-6 bg-black py-4 z-10'>
...
const SubscriptionPlans = () => {
    ...
    return (
        <section 
            id='subscriptions' 
            className='w-full bg-black text-gray-200 p-6 pt-10 
